...
public class TestQueryCache {
	public static void main(String[] args) {
		...
		Query q1 = session.createQuery("from UserDTO where id = 1"); // Create a new instance of Query for the given HQL
																		// query string

		q1.setCacheable(true); // Enable caching of this query result set
